...
class KNearestNeighbor:
    ...
    def calculate_distances(self, X_test, distance_metric='L2'):
        ...
        if distance_metric == 'L2':
            # Vectorized L2 distance (fra slides)
            # ||a - b||^2 = ||a||^2 + ||b||^2 - 2*a*b
    ...
    def predict(self, X_test, k, distance_metric='L2'):
        distances = self.calculate_distances(X_test, distance_metric)
